...
WebUI.setEncryptedText(findTestObject('Object Repository/login2/Page_JPetStore Demo/input_Need a user name and password_password'), 
    'NXt0rM6HQe0=')
...
WebUI.verifyElementText(findTestObject('Object Repository/login2/Page_JPetStore Demo/td_mohan1'), 'mohan1')
